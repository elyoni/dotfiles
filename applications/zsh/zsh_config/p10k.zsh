# Generated by Powerlevel10k configuration wizard on 2023-12-31 at 20:01 IST.
...
# blurred heads, flat tails, 2 lines, dotted, left frame, lightest-ornaments, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_TASKWARRIOR_CONTENT_EXPANSION='$(task +PENDING scheduled:today count)/$(task +ACTIVE +PENDING scheduled:today count)'
