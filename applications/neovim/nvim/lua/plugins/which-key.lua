return {
    ...
    opts = {
        ...
        spec = {
            { "<leader>a", group = "Cursor CLI/wiki" },
            { "<leader>af", desc = "Cursor CLI (float)" },
            { "<leader>av", desc = "Cursor CLI (vsplit)" },
            { "<leader>ah", desc = "Cursor CLI (hsplit)" },
            { "<leader>ac", desc = "Close Cursor CLI" },
            { "<leader>aa", desc = "Add selection to Cursor CLI" },
            { "<leader>hm", desc = "Open AI chat (Cursor CLI/neocodeium/Claude)" },
            { "<leader>d", group = "diff" },
            { "<leader>f", group = "find/telescope" },
            { "<leader>g", group = "git" },
            { "<leader>n", group = "new" },
            { "<leader>o", group = "obsidian" },
            { "<leader>oa", desc = "Active tasks" },
            ...
            { "<leader>oj", group = "jira" },
            { "<leader>ojn", desc = "New Jira ticket + link daily" },
            { "<leader>ojl", desc = "Link Jira ticket to daily" },
            { "<leader>ojo", desc = "Open active Jira tickets" },
            { "<leader>ojO", desc = "Open archived Jira tickets" },
            { "<leader>oja", desc = "Toggle active/archived Jira tickets" },
            { "<leader>on", desc = "New note" },
            { "<leader>oo", group = "open" },
            { "<leader>ou", desc = "New todo above" },
            { "<leader>ot", desc = "Tags" },
