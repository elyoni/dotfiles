...
return {
    ...
    },
    {
        ...
        config = function(_, opts)
            ...
            -- <leader>hm: on Work open Cursor CLI (float), on Private neocodeium chat, else Claude Code
            vim.schedule(function()
                vim.keymap.set("n", "<leader>hm", function()
                    ...
                    elseif FuncPrivatePC() then
                        ...
                        if vim.fn.exists(":ClaudeCode") == 1 then
                            vim.cmd("ClaudeCode")
                        end
                    end
                end, { desc = "Open AI chat (Cursor CLI / neocodeium / Claude)" })
            ...
            -- Visual <C-l>: open Cursor CLI float and add selection as @file:start-end
            ...
            -- Optional: cursorcli built-in keymaps (can override which-key <leader>a*)
